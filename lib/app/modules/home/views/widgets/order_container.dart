...
class OrderContainer extends GetView<HomeController> {
  const OrderContainer(this.showDetails, this.num, this.carName, this.groupName, this.date,  this.road,this.type, this.seats,this.remark, this.time, this.name, this.phone, this.address, this.i, this.start, this.end,  {Key? key}) : super(key: key);
                  ...
                  child: Row(
                    children: [
                      ...
                      showDetails ?   GestureDetector(
                        onTap: (){
                          controller.index.value == 0 ?controller.getDeliver(controller.activeOrders[i].id!, UserManager().user!.id,controller.activeOrders[i].customerId!):controller.getFinishDeliver(controller.deliverdOrders[i].id!,controller.activeOrders[i].customerId!);
