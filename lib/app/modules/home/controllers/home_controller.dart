...
class HomeController extends GetxController {
  ...
  var activeOrders = <OrderResponse>[].obs;
  var allActiveOrders = <OrderResponse>[].obs;
  final deliverdOrders = <OrderResponse>[].obs;
  final allOrders = <OrderResponse>[].obs;
  var delayedOrders = <OrderResponse>[].obs;
  var allDelayedOrders = <OrderResponse>[].obs;
  ...
  void onInit() {
   ...
   filter(String num){
     ...
     delayedOrders.value = List<OrderResponse>.from(allDelayedOrders.where((element) => element.customerName!.contains(num)).toList());
